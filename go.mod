...
require (
	...
	github.com/cloudfoundry/cloud-service-broker v0.10.0
...
replace github.com/cloudfoundry/cloud-service-broker => /Users/jatinnaik/workspace/csb/csb-brokerpak-gcp/../cloud-service-broker
